...
const Navbar = () => {
  ...
  return (
    <div className="md:w-[calc(100%-230px)] w-[calc(100%-60px)] fixed flex items-center justify-between pl-2 pr-6 h-[70px] top-0 md:left-[230px] left-[60px] border-b border-slate-300 bg-zinc-50">
      ...
      <div className="md:w-[800px] w-[130px] bg-gray-200 rounded-lg px-3 py-2 flex items-center gap-2">
        ...
        <input
          type="text"
          placeholder="Search"
          className="w-full bg-gray-200 outline-none text-base"
        />
      </div>
